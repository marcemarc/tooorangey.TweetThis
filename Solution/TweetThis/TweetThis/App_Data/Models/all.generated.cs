...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "4509a640cc825427")]
...
#pragma warning restore 0109
		...
		///</summary>
		[ImplementPropertyType("authenticatedTwitterAccount")]
		public object AuthenticatedTwitterAccount
		{
			get { return this.GetPropertyValue("authenticatedTwitterAccount"); }
		}
		...
		///<summary>
		/// Recent Tweets: A list of recent tweets for the authenticated account
		///</summary>
		[ImplementPropertyType("recentTweets")]
		public object RecentTweets
		{
			get { return this.GetPropertyValue("recentTweets"); }
		}
		...
		///<summary>
		/// Tweet Message Template: The template to use to generate default text for the twitter message, {0} means blog title - {1} means url
		///</summary>
		[ImplementPropertyType("tweetMessageTemplate")]
		public string TweetMessageTemplate
		{
			get { return this.GetPropertyValue<string>("tweetMessageTemplate"); }
		}
	}
